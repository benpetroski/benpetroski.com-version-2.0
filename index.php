					...
					<div id="text-3" class="widget widget_text">
						...
						<div class="col-lg-10 col-lg-offset-1 text-center">
							...
							<ul class="list-unstyled">
								<li><i class="fa fa-envelope-o fa-fw"></i> 50 Dudley Lane<br>Stanford, CA 94305<br><a
									href="mailto:ben@benpetroski.com">ben@benpetroski.com</a></li>
							</ul>
							<br>
							<ul class="list-inline">
								...
								<li><a class="pull-left social-media"
									href="https://github.com/benpetroski"><img
										src="images/githubIcon.png" height="35px" width="35px"></a>
								</li>
								<li><a class="pull-left social-media"
